...
$this->create_plugin_setting(
        ...
        __('Custom Module Slug','xoousers'),array(),
        __('Enter your custom Slug for the Dashboard Modules. Use this option only if there is a conflict with other plugins using the GET parameter with the name "module". Example "?module". <strong>WARNING!! </strong> Do not fill this field out if you are not sure about how to use it.','xoousers'),
        __('Enter your custom Slug for the Dashboard Modules.','xoousers')
);

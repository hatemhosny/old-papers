           ...
           <table width="100%" class="wp-list-table widefat fixed posts table-generic">
			...
			?>
                ...
                <tr  id="uu-edit-cate-row-<?php echo $c->photo_cat_id; ?>">
                    ...
                    <td>&nbsp;</td>
                     <td>&nbsp;</td>
                   <td> <a href="#" class="button uultra-photocat-del"  id="" data-gal="<?php echo $c->photo_cat_id; ?>"><i class="uultra-icon-plus"></i>&nbsp;&nbsp;<?php _e('Delete','xoousers'); ?>
                   </a>  <a href="#" class="button-primary button-secondary uultra-photocat-edit"  id="" data-gal="<?php echo $c->photo_cat_id; ?>"><i class="uultra-icon-plus"></i>&nbsp;&nbsp;<?php _e('Edit','xoousers'); ?>
</a> </td>
                </tr>

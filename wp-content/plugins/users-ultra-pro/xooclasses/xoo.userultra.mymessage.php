...
class XooUserMyMessage {
	...
	function show_view_my_message_form($message_id)
	{
		...
		if($message != "")
		{
			...
			$html .='	           
					  ...
					  <p><a class="uultra-btn-email" href="?module=messages"  data-id="'.$receiver_id.'"><span><i class="fa fa-chevron-left"></i></span>'. __("Back", 'xoousers').'</a>
	...
	function show_usersultra_my_messages()
	{
	    ...
	    $html .= '<div class="tablenav">
               ...
               <span style="float:left"><a href="?module=messages">'.__("Inbox", 'xoousers').'</a> | <a href="?module=messages_sent">'.__("Sent", 'xoousers').'</a></span> ';
	...
	function show_usersultra_my_messages_sent()
	{
     ...
     $html .= '<div class="tablenav">
               ...
               <span style="float:left"><a href="?module=messages">'.__("Inbox", 'xoousers').'</a> | <a href="?module=messages_sent">'.__("Outbox", 'xoousers').'</a></span>';

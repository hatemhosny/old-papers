...
<?php } ?>
	<tr>
		...
		<td><?php echo $oiopub_set->{$bz}['width']; ?> x <?php echo $oiopub_set->{$bz}['height']; ?></td>
	</tr>
	<tr>
...
<?php if($oiopub_set->general_set['upload'] == 1) { ?>
	<tr>
		<td><b><?php echo __oio("Banner Upload"); ?>:</b></td>
		<td>
			<input tabindex="8" type="file" name="oio_url" size="40" />&nbsp;[<a href="javascript://" title="<?php echo __oio("The banner image file to upload"); ?>"><b>?</b></a>]

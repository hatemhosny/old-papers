...
<div class="entry-content article-buttons row">
	...
	<div class="read-more btn col-xs-10 col-md-4 col-lg-2 col-xs-offset-1">
		<a class="col-xs-12" href="<?php the_permalink(); ?>"><span class="fa fa-file-text fa-lg"></span> Read More</a>
	</div>
    <?php endif ?> 
	<div class="read-more btn col-xs-10 col-md-4 col-lg-2 col-xs-offset-1 col-lg-offset-0">
	...
	<div class="read-more btn col-xs-10 col-md-4 col-lg-2 col-xs-offset-1 col-lg-offset-0">
		<a class="col-xs-12 article-addToPlaylist" href="#"  data-item-id="<?php the_ID(); ?>">

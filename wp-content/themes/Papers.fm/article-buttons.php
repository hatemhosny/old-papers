...
<div class="entry-content article-buttons row">
	...
	<div class="read-more btn col-xs-4 col-sm-10 col-md-4 col-lg-2 col-xs-offset-1 col-lg-offset-0">
		<a class="col-xs-12" href="<?php the_permalink(); ?>"><span class="add-to-playlist-icon dashicons dashicons-playlist-video"></span> Add to Playlist</a>
	</div>
	<div class="read-more btn col-xs-4 col-sm-10 col-md-4 col-lg-2 col-xs-offset-1 col-lg-offset-0">
		<a class="col-xs-12" href="<?php the_permalink(); ?>"><span class="fa fa-share-alt fa-lg"></span> Share</a>
	</div>
</div>

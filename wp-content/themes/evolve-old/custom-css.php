...
if ($evolve_width_layout == "fluid") { 
$evolve_css_data .= '.header {padding:0;} .custom-header {padding:40px 0px 5px 0px!important;position:relative;min-height:125px;background:url('.esc_url($header_image_src).') top center no-repeat;border-bottom:0;}'; 
} 
...
//mod by denzel, for typography.
//widget title typography
$evolve_widget_title_typo = evolve_get_option('evl_widget_title_font');
if($evolve_widget_title_typo['size']){
	$evolve_css_data .= ".widget-title{font-size:".$evolve_widget_title_typo['size']." !important;}";
}
if($evolve_widget_title_typo['face']){
	$evolve_css_data .= ".widget-title{font-family:".$evolve_widget_title_typo['face']." !important;}";
}
if($evolve_widget_title_typo['style']){
	$evolve_css_data .= ".widget-title{font-style:".$evolve_widget_title_typo['style']." !important;}";
}
if($evolve_widget_title_typo['color']){
	$evolve_css_data .= ".widget-title{color:".$evolve_widget_title_typo['color']." !important;}";
}
 
//widget content typography
$evolve_widget_content_typo = evolve_get_option('evl_widget_content_font');
if($evolve_widget_content_typo['size']){
	$evolve_css_data .= ".widget-content{font-size:".$evolve_widget_content_typo['size']." !important;}";
}
if($evolve_widget_content_typo['face']){
	$evolve_css_data .= ".widget-content{font-family:".$evolve_widget_content_typo['face']." !important;}";
}
if($evolve_widget_content_typo['style']){
	$evolve_css_data .= ".widget-content{font-style:".$evolve_widget_content_typo['style']." !important;}";
}
if($evolve_widget_content_typo['color']){
	$evolve_css_data .= ".widget-content, .widget-content a, .widget-content .tab-holder .news-list li .post-holder a, .widget-content .tab-holder .news-list li .post-holder .meta{color:".$evolve_widget_content_typo['color']." !important;}";
}

//mod by denzel, for h1 to h6 typography
for($i = 1; $i < 7; $i++){
//we get all h1 to h6 fonts, evl_content_h1_font ... to evl_content_h6_font values.
$h_tag = evolve_get_option('evl_content_h'.$i.'_font');
	//then we print out the values..
	if($h_tag['size']){
		$evolve_css_data .= ".entry-content h{$i}{font-size:".$h_tag['size']." !important;}";
	}
	if($h_tag['face']){
		$evolve_css_data .= ".entry-content h{$i}{font-family:".$h_tag['face']." !important;}";
	}
	if($h_tag['style']){
		$evolve_css_data .= ".entry-content h{$i}{font-style:".$h_tag['style']." !important;}";
	}
	if($h_tag['color']){
		$evolve_css_data .= ".entry-content h{$i}{color:".$h_tag['color']." !important;}";
	}
}

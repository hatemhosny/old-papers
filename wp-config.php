...
define( 'WPCACHEHOME', 'C:\Users\Hatem\Documents\My Web Sites\Papers-fm\wp-content\plugins\wp-super-cache/' ); //Added by WP-Cache Manager
define('WP_CACHE', true); //Added by WP-Cache Manager
define('DB_NAME', 'wordpress194');

/** MySQL database username */
define('DB_USER', 'wordpressuser194');

/** MySQL database password */
define('DB_PASSWORD', '#Ffj|o0Fi&_U');
